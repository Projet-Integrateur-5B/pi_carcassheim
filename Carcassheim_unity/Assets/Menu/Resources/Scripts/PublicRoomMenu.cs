...
public class PublicRoomMenu : Miscellaneous
{
	...
	/// <summary>
	/// Hide PublicRoomMenu <see cref = "PublicRoomMenu"/> class.
	/// </summary>
	...
	/// <summary>
	/// OnPacketReceived is called when a packet is received <see cref = "PublicRoomMenu"/> class.
	/// </summary>
	...
	/// <summary>
	/// Load the Scene in the background as the current Scene runs <see cref = "PublicRoomMenu"/> class.
	/// </summary>
	...
	/// <summary>
	/// Update is called once per frame <see cref = "PublicRoomMenu"/> class.
	/// </summary>
	void Update()
	{
		s_listAction.WaitOne();
