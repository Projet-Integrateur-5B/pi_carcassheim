    ...
    public class Serveur_main
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (fonctionReseauRecept != 0)
            {
                ...
                { // Réception d'une création de partie (un if dans le while de reception global) -> A DEPLACER dans thread com (faire un appel de fonction)
